  ...
  React.useEffect(() => {
    ...
    if (d3Container.current) {
      ...
      const event2 = {
        ...
        text: `<b>${formatTime(
          lockdowns
        )} </b> <br/> The lockdowns in Europe start.`,
        image_url:
          "https://www.gannett-cdn.com/presto/2020/03/15/USAT/e6e30693-9224-4c89-b003-6cc4b4348528-insta-noemoji-heart.png?width=660&height=660&fit=crop&format=pjpg&auto=webp",
      ...
      const event3 = {
        ...
        text: `<b>${formatTime(
          queens_gambit
        )}</b> <br/> The TV show Queen's Gambit is released on Netflix and was a huge hit.`,
        image_url:
      ...
      d3.csv(
        ...
        const buildRectangle = function (indx, group, event_obj) {
          ...
          var line = group.append("line").attr("id", `line${indx}`);
            ...
            .on("click", function (event, d) {
              ...
              d3.selectAll("rect").each(function (r, i) {
                ...
                if (
                  ...
                  other_rect.attr("select_state") == "selected"
                ) {
                  other_rect
                    .transition()
                    .duration(boxTime)
                  ...
                  d3.select(
                    `#line${other_rect
                      .attr("id")
                      .substring(other_rect.attr("id").length - 1)}`
                  )
                    .transition()
                    .duration(boxTime)
